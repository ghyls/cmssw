...
layerPairsDisplaced = [
    ...
    [28, 34, False, False,   2500,        40,       130,        20,        40,    10000,    -10000,     10000,  0.79433,    13,       3,       3,   0.1, 0.0095586,    15, 2.000e-04],
    ...
    [29, 34, False, False,   2500,        80,       130,        30,        60,    10000,    -10000,     10000,  0.59566,    13,       3,       3,   0.1,  0.017985,    15, 2.000e-04],
    ...
    [30, 34, False, False,   2000,        97,       120,        50,        80,   12.667,    -10000,     10000,  0.31623,    14,       3,     2.7,   0.1,    1.0945,    15, 2.000e-04],
    [30, 35, False, False,   1680,        79,       108,        50,        80,    10000,    -10000,     10000,  0.79433,    23,       3,       3,   0.1,  0.046416,    15, 2.000e-04],
    [30, 44, False, False,   2000,      -120,       -97,        50,        80,   12.667,    -10000,     10000,  0.31623,    14,       3,     2.7,   0.1,    1.0945,    15, 2.000e-04],
    ...
    [31, 35, False, False,   1660,        85,       116,        60,       110,    10000,    -10000,     10000,  0.70795,    35,       3,       3,   0.1,   0.11979,    15, 2.000e-04],
    [31, 45, False, False,   1660,      -116,       -85,        60,       110,    10000,    -10000,     10000,  0.70795,    35,       3,       3,   0.1,   0.11979,    15, 2.000e-04],
    [32, 33, False, False,   1860,    -10000,     10000,    -10000,     10000,    10000,       -29,        29,  0.59566,    30,       3,       3,   0.1,         3,    15,       0],
    [32, 35, False, False,   1540,        76,       116,        80,       110,    10000,    -10000,     10000,  0.50119,    46,       3,       3,   0.1,   0.22539,    15, 2.000e-04],
    [32, 45, False, False,   1540,      -116,       -76,        80,       110,    10000,    -10000,     10000,  0.50119,    46,       3,       3,   0.1,   0.22539,    15, 2.000e-04],
    ...
    [35, 37, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.59566,    47,       3,       3,   0.1,   0.22539,    15, 2.000e-04],
    [36, 38,  True, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.56234,    18,       3,       3,   0.1,      0.02,    15, 2.000e-04],
    [36, 39, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.74989,    47,       3,       3,   0.1,  0.087333,    15, 2.000e-04],
    [37, 39, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.56234,    47,       3,       3,   0.1,   0.16432,    15, 2.000e-04],
    [38, 40, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.35481,    16,       3,       3,   0.1,   0.16432,    15, 2.000e-04],
    [38, 41, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.74989,    47,       3,       3,   0.1,  0.063668,    15, 2.000e-04],
    [39, 41, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.56234,    45,       3,       3,   0.1,   0.58171,    15, 2.000e-04],
    [40, 42, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.29854,    18,       3,       3,   0.1,   0.79792,    15, 2.000e-04],
    [40, 43, False, False,   2500,        20,       115,        20,       115,       60,        15,        50,  0.70795,    48,       3,       3,   0.1,  0.063668,    15, 2.000e-04],
    [41, 43, False, False,   2500,        20,       115,        20,       115,   18.333,        15,        50,  0.50119,    47,       3,       3,   0.1,   0.58171,    15, 2.000e-04],
    [44, 46,  True, False,   2500,        20,       115,        20,       115,       60,       -50,       -15,  0.74989,    18,       3,       3,   0.1,      0.02,    15, 2.000e-04],
    [44, 47, False, False,   2500,        20,       115,        20,       115,       60,       -50,       -15,  0.79433,    43,       3,       3,   0.1,  0.063668,    15, 2.000e-04],
    ...
    [48, 50, False, False,   2500,        20,       115,        20,       115,       60,       -50,       -15,  0.35481,    16,       3,       3,   0.1,   0.16432,    15, 2.000e-04],
    [48, 51, False, False,   2500,        20,       115,        20,       115,       60,       -50,       -15,  0.74989,    47,       3,       3,   0.1,  0.063668,    15, 2.000e-04],
    [49, 51, False, False,   2500,        20,       115,        20,       115,       60,       -50,       -15,  0.56234,    45,       3,       3,   0.1,   0.58171,    15, 2.000e-04],
    [50, 52, False, False,   2500,        20,       115,        20,       115,       60,       -50,       -15,  0.29854,    18,       3,       3,   0.1,   0.79792,    15, 2.000e-04],
    [50, 53, False, False,   2500,        20,       115,        20,       115,       60,       -50,       -15,  0.70795,    48,       3,       3,   0.1,  0.063668,    15, 2.000e-04],
    [51, 53, False, False,   2500,        20,       115,        20,       115,   18.333,       -50,       -15,  0.50119,    47,       3,       3,   0.1,   0.58171,    15, 2.000e-04],
]
...
hltPhase2PixelTracksSoADisplacedWithStubs = cms.EDProducer('CAHitNtupletAlpakaPhase2OTStubs@alpaka',
    ...
    maxStubTip  = cms.double(15.0),  # the displaced arm targets the same tip as its caDCA [cm]
