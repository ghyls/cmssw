...
layerPairs = [
    ...
    [  5,  28,  False,  False,    1000,    11.6,   10000,       40,       80,     16,       5,      50,    0.85,      13,          5,          5,      -1,    0.003,     0.5,        0],
    ...
    [ 17,  28,  False,  False,    1000,    11.6,   10000,      -80,      -40,     16,     -50,      -5,    0.85,      13,          5,          5,      -1,    0.003,     0.5,        0],
    ...
    [ 28,  34,  False,  False,    2500,      40,     130,       20,       40,  10000,  -10000,   10000,    0.85,      13,          5,          5,     0.1,    0.005,       3,   0.0002],
    [ 29,  34,  False,  False,    2500,      80,     130,       30,       60,  10000,  -10000,   10000,    0.85,      13,          5,          5,     0.1,    0.005,       3,   0.0002],
    ...
    [ 31,  35,  False,  False,    1000,      90,     116,       60,      110,  10000,  -10000,   10000,    0.85,      35,          3,          3,    0.05,  0.06984,       5,        0],
    [ 32,  35,  False,  False,    1000,      99,     116,       80,      110,  10000,  -10000,   10000,    0.85,      46,          3,          3,    0.05,    0.096,       5,        0],
    # OT barrel (PS L1-L3) to the first z < 0 disk, PS layer (44)
    [ 28,  44,  False,  False,    2500,    -130,     -40,       20,       40,  10000,  -10000,   10000,    0.85,      13,          5,          5,     0.1,    0.005,       3,   0.0002],
    [ 29,  44,  False,  False,    2500,    -130,     -80,       30,       60,  10000,  -10000,   10000,    0.85,      13,          5,          5,     0.1,    0.005,       3,   0.0002],
    [ 30,  44,  False,  False,    2000,    -130,    -100,       50,       80,  10000,  -10000,   10000,    0.85,    13.0,        5.0,        5.0,     0.1,    0.005,       3,   0.0002],
    # barrel-2S -> 2S(disk) at z < 0
    [ 31,  45,  False,  False,    1000,    -116,     -90,       60,      110,  10000,  -10000,   10000,    0.85,      35,          3,          3,    0.05,  0.06984,       5,        0],
    [ 32,  45,  False,  False,    1000,    -116,     -99,       80,      110,  10000,  -10000,   10000,    0.85,      46,          3,          3,    0.05,    0.096,       5,        0],
    ...
    [ 34,  37,  False,  False,    1000,      45,      72,       55,      105,  10000,  -10000,   10000,    0.85,      42,          3,          3,    0.05,   0.1312,       5,        0],  # PS->2S
    ...
    [ 38,  41,  False,  False,    1000,      20,     115,       20,      115,  10000,  -10000,   10000,    0.85,      47,          3,          3,    0.05,  0.05096,       5,        0],  # PS->2S
    [ 40,  42,  False,  False,    2500,      20,     115,       20,      115,     60,      15,      50,    0.85,      16,          6,          7,     0.1,     0.02,    0.65,   0.0002],
    [ 40,  43,  False,  False,    1000,      20,     115,       20,      115,  10000,  -10000,   10000,    0.85,      48,          3,          3,    0.05,  0.06984,       3,   0.0002],  # PS->2S
    # 2S->2S chain at z > 0; caDCA is loose because the gate-all triplet DNN carries the purity here.
    [ 35,  37,  False,  False,    1000,      55,     105,       55,      105,  10000,  -10000,   10000,    0.85,      47,          3,          3,    0.05,   0.1312,       5,        0],
    ...
    [ 41,  43,  False,  False,    1000,      55,     105,       55,      105,  10000,  -10000,   10000,    0.85,      47,          3,          3,    0.05,   0.3392,       5,        0],
    ...
    [ 44,  47,  False,  False,    1000,      45,      72,       55,      105,  10000,  -10000,   10000,    0.85,      42,          3,          3,    0.05,   0.1312,       5,        0],  # PS->2S
    ...
    [ 48,  51,  False,  False,    1000,      20,     115,       20,      115,  10000,  -10000,   10000,    0.85,      47,          3,          3,    0.05,  0.05096,       5,        0],  # PS->2S
    [ 50,  52,  False,  False,    2500,      20,     115,       20,      115,     60,     -50,     -15,    0.85,      16,          6,          7,     0.1,     0.02,    0.65,   0.0002],
    [ 50,  53,  False,  False,    1000,      20,     115,       20,      115,  10000,  -10000,   10000,    0.85,      48,          3,          3,    0.05,  0.06984,       3,   0.0002],  # PS->2S
    # 2S->2S chain at z < 0, loose as the z > 0 chain above
    [ 45,  47,  False,  False,    1000,      55,     105,       55,      105,  10000,  -10000,   10000,    0.85,      47,          3,          3,    0.05,   0.1312,       5,        0],
    ...
    [ 51,  53,  False,  False,    1000,      55,     105,       55,      105,  10000,  -10000,   10000,    0.85,      47,          3,          3,    0.05,   0.3392,       5,        0],
]
...
hltPhase2PixelTracksSoAWithStubs = cms.EDProducer('CAHitNtupletAlpakaPhase2OTStubs@alpaka',
    ...
    maxStubTip  = cms.double(0.1),   # transverse displacement this iteration admits [cm]
