...
# The configuration in this file will be dumped into a .json file. The json will
# then be read by test_dumpDependencyGraph_check.py, which will check that its
# contents match what this file declares. Changes to this file should be
# manually reflected into test_dumpDependencyGraph_check.py .
...
# It will be checked that process.viaAlias's dependency, via aliasOfSecond,
# resolves to process.second
...
# does not exist) is reported as unresolved, not as a normal edge
# It will be also checked that no other module has an unresolved dependency
