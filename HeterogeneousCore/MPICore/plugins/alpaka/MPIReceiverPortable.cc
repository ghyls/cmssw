...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  class MPIReceiverPortable
      : public ProducerBase<edm::stream::EDProducer, edm::ExternalWork, edm::GlobalCache<InformationFlag>> {
  public:
    MPIReceiverPortable(edm::ParameterSet const& config, InformationFlag const* cache)
        : ProducerBase<edm::stream::EDProducer, edm::ExternalWork, edm::GlobalCache<InformationFlag>>(config),
    ...
    static std::unique_ptr<InformationFlag> initializeGlobalCache(edm::ParameterSet const&) {
      return std::make_unique<InformationFlag>();
    }

    static void globalEndJob(InformationFlag const*) {}
