...
class MPISender : public edm::stream::EDProducer<edm::ExternalWork, edm::GlobalCache<InformationFlag>> {
public:
  MPISender(edm::ParameterSet const& config, InformationFlag const* cache)
