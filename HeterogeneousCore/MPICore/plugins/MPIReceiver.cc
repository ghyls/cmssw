...
class MPIReceiver : public edm::stream::EDProducer<edm::ExternalWork, edm::GlobalCache<InformationFlag>> {
public:
  MPIReceiver(edm::ParameterSet const& config, InformationFlag const* cache)
