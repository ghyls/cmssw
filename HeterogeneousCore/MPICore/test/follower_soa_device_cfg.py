...
process.receiver = cms.EDProducer("MPIReceiverPortable@alpaka",
    ...
    products = cms.VPSet(
        # DeviceObjects are not (yet) supported by the portable MPI modules
        # cms.PSet(
        #     type = cms.string("portabletest::TestDeviceObject"),
        #     src = cms.InputTag("", ""),
        # ),
        cms.PSet(
            type = cms.string("PortableDeviceCollection<portabletest::TestSoA>"),
            src = cms.InputTag("", ""),
        ),
        cms.PSet(
            type = cms.string("PortableDeviceCollection<portabletest::TestSoABlocks2>"),
            src = cms.InputTag("", ""),
        ),
        cms.PSet(
            type = cms.string("PortableDeviceCollection<portabletest::TestSoABlocks3"),
            src = cms.InputTag("", ""),
        ),
    )
)
