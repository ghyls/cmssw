#ifndef HeterogeneousCore_SerialisationCore_interface_MemoryCopyTraits_h
#define HeterogeneousCore_SerialisationCore_interface_MemoryCopyTraits_h
...
#endif  // HeterogeneousCore_SerialisationCore_interface_MemoryCopyTraits_h
