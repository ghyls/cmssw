...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  private:
    ...
    // Seam state (per stream), cleared at acquire entry so a skipped produce() cannot leak:
    // pendingTracks_ is built in acquire and emplaced in produce; countsHost_ is a 2-word host
